...
const Sidebar = () => {
  ...
  return (
    <motion.div
      ...
      className=" bg-white h-screen py-4 text-white fixed shadow-xl z-10"
    >
      <div
      ...
      >
        <>
          <div className="flex items-center">
            ...
            <motion.button
              initial={{ rotate: 0 }}
              animate={{ rotate: activeMenu ? 0 : 180 }}
              onClick={() => setActiveMenu((prev) => !prev)}
              style={{ backgroundColor: currentColor }}
              className="rounded-full absolute -right-2 outline-none text-xl  p-2"
            >
              <IoIosArrowForward />
            </motion.button>
          </div>
